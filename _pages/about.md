...
My research interests aim to (1) understand the brain mechanisms involved in representing current affective experiences, and (2) examine the role that daily affective experiences play in shaping the way that people experience affect in the present. I use advanced neuroimaging, immunology, and experience sampling techniques to examine the ways that the brain, body, and day-to-day experiences come together in creating our perception of emotions. This is done in combination with sensitive cognitive and behavioral measures that experimentally manipulate the experience of emotions.
